...
// Added 'border' property for each status
const PAYMENT_STYLES: Record<string, { bg: string; text: string; border: string; icon: ReactElement }> = {
  pending: {
    bg: "bg-yellow-100",
          ...
          <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
            {filteredOrders.map((order) => {
              ...
              const displayedMethod =
                paymentStatus === "pending" ? "Not Selected" : currentMethod;
              ...
              return (
                ...
                >
                  ...
                  {/* ---------- Payment status buttons with status‑specific borders ---------- */}
                  <div className="mt-4">
                      ...
                      {PAYMENT_STATUS_OPTIONS.map((status) => {
                        ...
                        return (
                          <button
                            ...
                            className={`
                              flex items-center justify-center gap-1.5 rounded-xl border-2 px-3 py-2 
                    ...
                    <div className="mt-1 text-xs text-gray-400 text-center">
                      Current method: {PAYMENT_METHOD_LABELS[displayedMethod] ?? displayedMethod}
                    </div>
                  </div>
                  {/* -------------------------------------------------------------- */}
                </div>
